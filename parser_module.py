...
class CreditCardParser:
    ...
    def parse_statement(self, pdf_path: str) -> CreditCardData:
        """Main parsing function with encrypted PDF support"""
    ...
    def _decrypt_with_password(self, pdf_path: str, password: str) -> str:
...
def main():
    ...
    try:
        # Parse the statement (now handles encrypted PDFs automatically)
